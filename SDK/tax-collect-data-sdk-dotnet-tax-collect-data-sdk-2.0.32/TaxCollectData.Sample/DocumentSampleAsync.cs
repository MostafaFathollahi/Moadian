...
public class DocumentSampleAsync
{
    private const string MemoryId = "A111DW";
    private const string ApiUrl = "https://tp-nta.abriment.mohaymen.ir/requestsmanager";
    ...
    public static async Task RunAsync()
    {
        ...
        var responseModels =
            await taxApi.SendInvoicesAsync(invoiceList);
        ...
        var inquiryDto = new InquiryByReferenceNumberDto(responseModels.Select(r => r.ReferenceNumber).ToList(), startDate, endDate);
        var inquiryResults = await taxApi.InquiryByReferenceIdAsync(inquiryDto);
