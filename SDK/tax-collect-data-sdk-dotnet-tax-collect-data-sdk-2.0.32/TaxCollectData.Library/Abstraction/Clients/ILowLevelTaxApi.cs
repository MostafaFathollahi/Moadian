...
public interface ILowLevelTaxApi
{
    ...
    Task<List<InvoiceStatusInquiryResponseDto>> InquiryInvoiceStatusAsync(List<string> taxIds);
    RegisterPaymentResultModel RegisterPaymentRequest(RegisterPaymentRequestDto paymentRequestDto);
    Task<RegisterPaymentResultModel> RegisterPaymentRequestAsync(RegisterPaymentRequestDto paymentRequestDto);
}