...
public class TaxApi : ITaxApi
{
    ...
    public async Task<List<InvoiceResponseModel>> SendInvoicesAsync(List<InvoiceDto> invoices)
    {
        ...
        var map = invoicePackets.ToDictionary(i => i.PacketDto.Header.RequestTraceId, i => i.TaxId);
