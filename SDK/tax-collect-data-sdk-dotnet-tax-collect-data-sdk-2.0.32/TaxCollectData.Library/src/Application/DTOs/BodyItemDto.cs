...
{
    public string sstid { get; set; } = string.Empty;
    public string sstt { get; set; } = string.Empty;
    ...
    public string odt { get; set; } = string.Empty;
    public decimal? odr { get; set; }
    public long? odam { get; set; }
    public string olt { get; set; } = string.Empty;
    ...
    public string bsrn { get; set; } = string.Empty;
